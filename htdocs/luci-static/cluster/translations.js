...
window.clusterTranslations = {
  ...
  zh: {
    ...
    // Theme Settings
    "cluster Theme Settings": "cluster 主题设置",
    "Theme Mode": "主题模式",
    Dark: "深色",
    Light: "浅色",
  ...
  de: {
    ...
    // Theme Settings
    "cluster Theme Settings": "cluster Theme-Einstellungen",
  ...
  uk: {
    ...
    // Theme Settings
    "cluster Theme Settings": "Налаштування теми cluster",
  ...
  es: {
    ...
    // Theme Settings
    "cluster Theme Settings": "Configuración del Tema cluster",
  ...
  pt: {
    ...
    // Theme Settings
    "cluster Theme Settings": "Configurações do Tema cluster",
  ...
  pl: {
    ...
    // Theme Settings
    "cluster Theme Settings": "Ustawienia Motywu cluster",
  ...
  fr: {
    ...
    // Theme Settings
    "cluster Theme Settings": "Paramètres du Thème cluster",
  ...
  it: {
    ...
    // Theme Settings
    "cluster Theme Settings": "Impostazioni Tema cluster",
...
window.clusterT = function (key) {
  ...
  if (
    window.clusterTranslations &&
    window.clusterTranslations[langBase] &&
    window.clusterTranslations[langBase][key]
  ) {
    return window.clusterTranslations[langBase][key];
  }
